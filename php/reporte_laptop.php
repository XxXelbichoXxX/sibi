<?php
    ...
    header("content-Disposition: attachment; filename=datos-laptop.xls");
?>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<table>
    <caption>Datos de Laptop</caption>
    <tr>
    ...
    $consulta = mysqli_query($conexion, "SELECT * FROM laptop");   
