<?php
    ...
    header("content-Disposition: attachment; filename=datos-telefonia.xls");
?>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<table>
    <caption>Datos de Telefonia</caption>
    <tr>
    ...
    $consulta = mysqli_query($conexion, "SELECT * FROM telefonia");   
