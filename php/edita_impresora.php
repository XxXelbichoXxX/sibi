...
<body>
    <div class="form-style">
        <form action="../php/tools/edita_datos_impresora.php" method="post" class="form-container">
            <div class="cpu">
                ...
                $sql = "select * from impsca where serie='$serie'";
                ...
                <div class="datos">
                    <div class="box">
                        ...
                        <select id="tipo" name="tipo">
                            <option <?php echo $row['tipo'] === 'IMPRESORA' ? "selected='selected'" : "" ?>value='IMPRESORA'>IMPRESORA</option>
                            <option <?php echo $row['tipo'] === 'SCANNER' ? "selected='selected'" : "" ?>value='SCANNER'>SCANNER</option>
                        </select>
                    </div>
                    <div class="box">
                        <label for="marca">Marca</label>
                        <select id="marca" name="marca">
                            <option <?php echo $row['marca'] === 'XEROX' ? "selected='selected'" : "" ?>value='XEROX'>XEROX</option>
                            <option <?php echo $row['marca'] === 'OKIDATA' ? "selected='selected'" : "" ?>value='OKIDATA'>OKIDATA</option>
