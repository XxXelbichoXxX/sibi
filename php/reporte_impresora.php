<?php
    ...
    header("content-Disposition: attachment; filename=datos-impsca.xls");
?>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<table>
    <caption>Datos de la impresora o Scanner</caption>
    <tr>
    ...
    $consulta = mysqli_query($conexion, "SELECT * FROM impsca");   
